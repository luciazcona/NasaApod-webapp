...
// Consultar la base de datos para obtener el título, la descripción y la URL de la imagen
$sql = "SELECT final_titulos.titulo, final_fechas.fecha, final_explicaciones.explicacion, final_url_imagenes.url_imagen, final_copyright.copyright
        ...
        WHERE final_titulos.titulo LIKE '%$titulo%'";
...
if ($result->num_rows > 0) {
    ...
    echo json_encode(array("error" => "There are no images for the input title."));
}
